...
rooms_parser.add_argument('tenant_id', type=str, **default_config)
...
rooms_staff_parser = reqparse.RequestParser(bundle_errors=True)
rooms_staff_parser.add_argument('staff_passport_id', type=str,
                                **default_config)
rooms_staff_parser.add_argument('room_number', type=str, **default_config)
